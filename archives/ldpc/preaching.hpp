...
#ifndef INCLUDED_PREACHING_HPP
#define INCLUDED_PREACHING_HPP
...
public:
	...
	// Both functor members are of the form inline static void callback(unsigned y, unsigned x)
